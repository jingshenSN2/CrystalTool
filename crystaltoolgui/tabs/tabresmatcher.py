...
class Ui_tabresmatcher(object):
    ...
    def retranslateUi(self, tabresmatcher):
        ...
        self.lE_match_sort.setText(_translate("tabresmatcher", "-Tm,-Rwm,-Nm,-Ram,-Rc"))
