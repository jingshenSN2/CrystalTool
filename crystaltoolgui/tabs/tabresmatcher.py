...
class Ui_tabresmatcher(object):
    def setupUi(self, tabresmatcher):
        ...
        self.cB_Rwe4 = QtWidgets.QCheckBox(tabresmatcher)
        self.cB_Rwe4.setObjectName("cB_Rwe4")
        self.hL_match_output.addWidget(self.cB_Rwe4)
    ...
    def retranslateUi(self, tabresmatcher):
        ...
        self.cB_Rwe4.setText(_translate("tabresmatcher", "Rwe4"))
