...
class Ui_tabresmatcher(object):
    def setupUi(self, tabresmatcher):
        ...
        self.hL_match_output.addWidget(self.cB_Ram)
    ...
    def retranslateUi(self, tabresmatcher):
        ...
        self.cB_threshold.setItemText(2, _translate("tabresmatcher", "Rm(匹配比例)"))
        ...
        self.lE_match_sort.setText(_translate("tabresmatcher", "-Rwe2,-Rwm,-Nm,-Ram,-Rc"))
